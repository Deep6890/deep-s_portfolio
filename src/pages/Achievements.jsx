...
import { certificates, events, importantCourses, basicCourses } from '../data/achievementsData'
  ...
  return (
    <section className="min-h-screen bg-white dark:bg-neutral-900">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* BASIC COURSES */}
        <Section
          label="Foundational Studies"
          description="Early-stage academic groundwork and essential coursework."
        >
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
            {basicCourses.map((course) => (
              <div
                key={course.id}
                className="border border-neutral-200 dark:border-neutral-700 rounded-xl p-5 hover:border-neutral-400 dark:hover:border-neutral-500 transition"
              >
                <h4 className="text-sm font-light text-neutral-900 dark:text-white mb-1">
                  {course.title}
                </h4>
